  ...
  return (
    <div className='flex flex-col my-28 gap-16 items-center justify-center w-full min-h-[80vh]' id="section4" ref={section4ref}>
      ...
      <div id="section4images" className='flex flex-col md:flex-row md:justify-around gap-3 p-3 items-center w-full'>
        {[
          { img: section4AllImages[2]?.guid, text: "Exclusive Design"},
          { img: section4AllImages[1]?.guid, text: "Visual Builder" },
          { img: section4AllImages[3]?.guid, text: "Powerful Tools" },
          { img: section4AllImages[0]?.guid, text: "Quick Importer" }
        ].map((imgUrl, idx) => (
          // <div
          //   key={idx}
